...
%DIF ADD irrigationImpact.tex       Mon May 16 22:54:58 2016
...
\DIFdelbegin \DIFdel{It turned out that the }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend irrigated water applied in the IRG simulation was $\sim$2.84 mm/day in JJA when averaged over the CV, which equates to 31.7 km$^3$ total water. \DIFdelbegin \DIFdel{In the }\DIFdelend \DIFaddbegin \DIFadd{Given that no reliable and comprehensive dataset on cropland use is available, and information on local irrigation practices is even more sparse, it was determined that there was no precise public numbers about the irrigation area and the irrigation water over CV. However, as mentioned earlier, in the }\DIFaddend year 2000 \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{the }\DIFaddend USGS reported that approximately 42 km$^3$ of water was used over \DIFaddbegin \DIFadd{approximately }\DIFaddend 41,000 km$^2$ of irrigated area in California. \DIFaddbegin \DIFadd{Based on the fraction of cropland that is equipped for irrigation for year 2000 from \mbox{%DIFAUXCMD
\citet{siebert2005development}
}%DIFAUXCMD
, we arrived at an estimate of irrigated area within the CV of about 33,190 km$^2$, which is about 81$\%$ of California's total irrigation area.  }\DIFaddend Assuming between half to two thirds of the 42 km$^3$ of water was employed over the CV during JJA \DIFaddbegin \DIFadd{(excluding certain water amount for late spring and early fall)}\DIFaddend , that resolves to about 21 to 28 km$^3$, or 0.66 to 0.88 times the amount used by IRG \DIFaddbegin \DIFadd{($\sim32 \mbox{km}^3$)}\DIFaddend . These numbers suggest that the water use imposed by this irrigation scheme is \DIFdelbegin \DIFdel{fairly realistic}\DIFdelend \DIFaddbegin \DIFadd{close to reality}\DIFaddend .
...
With irrigation enabled, the specific humidity increased by about 12$\%$ due to increased evaporation, and sensible heat flux decreased by 13\% with lower surface temperatures and a shift of sensible to latent heat flux. \DIFdelbegin \DIFdel{Nonetheless, the }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend soil moisture averaged over all \DIFdelbegin \DIFdel{the subsurface layers only showed a slight increase ($\sim4\%$}\DIFdelend \DIFaddbegin \DIFadd{surface and subsurface soil layers showed a statistically significant increase ($\sim4.4\%$}\DIFaddend ) under irrigation\DIFdelbegin \DIFdel{, although this value is still statistically significant under the t-test. Although }\DIFdelend \DIFaddbegin \DIFadd{. Since variability of the soil moisture is smaller at lower levels compared to upper levels, even a 4.4$\%$ change was significant.  The relative magnitude of this change was apparently when only the first few thin soil layers in CLM 4.0 were considered, with soil water increased by 10$\%$ in the topmost five layers (reaching $\sim52\%$ at the first thin layer).
}


\DIFadd{We note that the small change of soil moistures (averaged over all the ten soil layers) between IRG and IRG(0.5) (about 1.4$\%$, but still significant at the 95}\% \DIFadd{level) suggest that irrigated water does not effectively infiltrate into lower soil layers, given that }\DIFaddend the irrigated water \DIFdelbegin \DIFdel{added in IRG }\DIFdelend \DIFaddbegin \DIFadd{applied in IRG is more than two times that of IRG}\DIFaddend (0.5)\DIFdelbegin \DIFdel{was nearly half of that in IRG , it did not lead to statistically significant differences for those relevant variables, and simply led to smaller }\DIFdelend \DIFaddbegin \DIFadd{. It was observed that the soil water between IRG and IRG(0.5) is significantly different at the ground surface ($\sim5\%$ changes) and in the bottom layers ($\sim1\%$ changes), but not for near-surface and middle levels. It turns out that most of the added water ($\sim$1.57 mm/day) from IRG(0.5) to IRG directly led to surface }\DIFaddend runoff (parameterized by removing surface water after infiltration into the soil \DIFdelbegin \DIFdel{) (}\DIFdelend \DIFaddbegin \DIFadd{at }\DIFaddend $\sim$0.24 mm/day \DIFdelbegin \DIFdel{) compared with IRG(}\DIFdelend \DIFaddbegin \DIFadd{for IRG(0.5) and }\DIFaddend $\sim$1.6 mm/day \DIFdelbegin \DIFdel{)}\DIFdelend \DIFaddbegin \DIFadd{for IRG). Since irrigation water use in the IRG simulations is comparable to observations, this suggests that there is an ongoing and substantial waste of irrigation water in the CV}\DIFaddend .
\DIFdelbegin \DIFdel{This suggests that irrigated water does not effectively infiltrate into lower soil layers.
}\DIFdelend 


Based on the JJA-averaged values \DIFdelbegin \DIFdel{over 26 years}\DIFdelend \DIFaddbegin \DIFadd{of each year over the 26-year period}\DIFaddend , the distributions of four selected variables are depicted in the box and whisker diagram in Figure \ref{fig:Figure 4}. With irrigation, both the average magnitude and annual variability of Tmax \DIFaddbegin \DIFadd{(around 0.9$^\circ$C) }\DIFaddend are closer to observations. Compared to NRG, the range of Tmax for irrigation runs reduced to $\sim$3$^\circ$C from $\sim$4.5$^\circ$C with a \DIFdelbegin \DIFdel{less }\DIFdelend \DIFaddbegin \DIFadd{more }\DIFaddend concentrated distribution, suggesting \DIFdelbegin \DIFdel{irrigation had }\DIFdelend \DIFaddbegin \DIFadd{that there may be some indication of irrigation having }\DIFaddend a modulating effect on temperature variability (although the differences of variances are not statistically significant). The mean latent heat flux almost doubles when irrigation in enabled, however the variance of the distribution \DIFaddbegin \DIFadd{(with inter-annual variation of $\sim$2.7 $W/m^2$ for IRG and $\sim$3.3 $W/m^2$ for IRG(0.5)) }\DIFaddend did not substantially differ from NRG \DIFdelbegin \DIFdel{. Average }\DIFdelend \DIFaddbegin \DIFadd{(with inter-annual variation of $\sim$3.7 $W/m^2$). 
}
...
. 
}\DIFdelend \DIFaddbegin \DIFadd{. There are no significant changes at the 90$\%$ level (the same level as \mbox{%DIFAUXCMD
\cite{lo2013irrigation}
}%DIFAUXCMD
used) to precipitation, low-level cloud, near-surface specific humidity and CAPE, and the moisture flux anomaly at 850 hPa over the U.S. southwest (see Figure 3 in the supplement) where \mbox{%DIFAUXCMD
\cite{lo2013irrigation}
}%DIFAUXCMD
found changes attributed to irrigation in the CV. We do see that there are certain positive increases of precipitation, low-level cloud and CAPE between IRG and NRG over some regions of Nevada and Utah, but these are not present when comparing IRG(0.5) and NRG.
}\DIFaddend 
